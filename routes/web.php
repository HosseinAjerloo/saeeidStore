...
Route::prefix('admin')->name('admin.')->group(function (){
   ...
   Route::prefix('category')->name('category.')->group(function (){
       ...
       Route::get('edit/{user}',[\App\Http\Controllers\Admin\Category\ProductCategory::class,'edit'])->name('edit');
       Route::put('update/{user}',[\App\Http\Controllers\Admin\Category\ProductCategory::class,'update'])->name('update');
       Route::delete('destroy/{user}',[\App\Http\Controllers\Admin\Category\ProductCategory::class,'destroy'])->name('destroy');
   });
});
