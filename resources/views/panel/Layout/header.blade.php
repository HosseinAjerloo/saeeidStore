        ...
        <div class="container">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu mega-menu  show" data-popper-placement="bottom-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 42px, 0px);">
                        <div class="d-flex justify-between flex-wrap gap-3">
                        @foreach($categories as $category)
                                <div >
                                    <h6 class="text-center">{{$category->name??''}}</h6>
                                    @foreach($category->childs as $child)
                                        <a href="search.html" class="mega-item d-block">
