        ...
        <div class="mx-auto max-w-5xl">
            <section class="list-hero animate-fade-up mb-6">
                <div class="relative flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <span class="chip bg-brand-500/10 text-brand-300">ویرایش تگ</span>
            ...
            <form id="tagForm" action="{{route('admin.tag.update',$tag)}}" method="post" novalidate="">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-5 p-5 sm:p-7">
                            <label class="field-group"><span
                                ...
                                <span class="field-shell">
                                    ...
                                    <input id="tagName" value="{{old('name',$tag->name)}}" name="name" type="text" maxlength="255" placeholder="مثلاً پرفروش">
                                </span>
                                <small
                            ...
                            <div class="field-group">
                                ...
                                <label
                                    ...
                                    <span
                                        class="relative">
                                        <input id="tagActive" name="is_active" type="checkbox" value="1"@if($tag->is_active) checked  @endif class="peer sr-only">
                                        <span class="block h-6 w-11 rounded-full bg-ink-600 peer-checked:bg-brand-500"></span>
                                        <span class="absolute right-1 top-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:-translate-x-3">
                                        </span>
                                    </span>
                                </label>
                            </div>
