...
@section('title')
    <title>پنل | ویرایش برند جدید</title>
@endsection
...
@section('content')
    <main class="flex-1 p-4 sm:p-6 lg:p-8">
        <div class="mx-auto max-w-7xl">
            <section
                ...
                <div class="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <h2 class="text-2xl font-extrabold text-white sm:text-3xl">ویرایش برند محصول</h2>
            ...
            <form id="createGroupForm" action="{{route('admin.brand.update',$productBrand)}}" method="post"
                            ...
                            <div class="grid grid-cols-1 p-5 sm:grid-cols-2 gap-2  sm:p-7">
                                <label class="field-group">
                                    ...
                                    <span class="field-shell">
                                        ...
                                        <input id="groupName" value="{{old('name',$productBrand->name)}}" name="name" type="text"
                                ...
                                <label class="field-group">
                                    ...
                                    <span class="field-shell">
                                        <svg viewBox="0 0 24 24"><path d="M3 6h7l2 2h9v11H3z"></path></svg>
                                        <input id="groupName" dir="ltr" value="{{old('website',urldecode($productBrand->website))}}" name="website" type="text"
                                               required="" maxlength="255"
                                ...
                                <label class="field-group">
                                    ...
                                    <span
                                        ...
                                        <textarea id="description" name="description" rows="5" maxlength="1000"
                                                  placeholder="توضیحی کوتاه درباره محصولات این برند بنویسید...">{{old('description',$productBrand->description)}}</textarea>
                                    </span>
                                    <span
                    ...
                    <aside class="space-y-5 xl:col-span-4">
                        <section
                            ...
                            <div id="imagePreview"
                                ...
                                <img id="previewImg" src="{{asset($productBrand->logo)}}" alt="پیش‌نمایش تصویر برند"
                                     class="absolute inset-0 @if(!isset($productBrand->logo)) hidden @endif h-full w-full object-cover">
                                <span id="statusPreview" class= "absolute left-4 top-4 chip backdrop-blur-md bg-brand-500/15 text-brand-300"><span
